    ...
    <div className="flex flex-col w-full relative">
      ...
      <div className="relative w-full">
        <button
          ...
          className={`absolute left-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-[rgba(16,16,16,0.8)] to-transparent slider-nav-arrow w-24 flex items-center justify-center text-white p-2 z-50 transition-opacity duration-300 ${
        ...
        <button
          ...
          className={`absolute right-0 top-1/2 transform -translate-y-1/2 bg-gradient-to-l from-[rgba(16,16,16,0.8)] to-transparent slider-nav-arrow w-24 flex items-center justify-center text-white p-2 z-50 transition-opacity duration-300 ${
